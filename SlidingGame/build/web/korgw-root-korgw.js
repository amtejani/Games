(function (root, factory) {
  ...
  var get_hrSeconds = $module$klock_root_klock.com.soywiz.klock.hr.get_hrSeconds_s8ev3n$;
  ...
  var get_hrMicroseconds = $module$klock_root_klock.com.soywiz.klock.hr.get_hrMicroseconds_yrwdxr$;
  ...
  var get_hrNanoseconds = $module$klock_root_klock.com.soywiz.klock.hr.get_hrNanoseconds_yrwdxr$;
  var CoroutineContext$Element = Kotlin.kotlin.coroutines.CoroutineContext.Element;
  var get_hrSeconds_0 = $module$klock_root_klock.com.soywiz.klock.hr.get_hrSeconds_yrwdxr$;
  var get_hrNanoseconds_0 = $module$klock_root_klock.com.soywiz.klock.hr.get_hrNanoseconds_s8ev3n$;
  var blockingSleep = $module$klock_root_klock.com.soywiz.klock.blockingSleep_seyb0p$;
  var std = $module$korio_root_korio.com.soywiz.korio.file.std;
  var split = Kotlin.kotlin.text.split_ip8yn$;
  var localVfs = $module$korio_root_korio.com.soywiz.korio.file.std.localVfs_61zpoe$;
  ...
  AGOpengl$ShaderException.prototype = Object.create(RuntimeException.prototype);
  AGOpengl$ShaderException.prototype.constructor = AGOpengl$ShaderException;
  ...
  GameWindowCoroutineDispatcherSetNow.prototype = Object.create(GameWindowCoroutineDispatcher.prototype);
  GameWindowCoroutineDispatcherSetNow.prototype.constructor = GameWindowCoroutineDispatcherSetNow;
  ...
  EventLoopGameWindow.prototype = Object.create(GameWindow.prototype);
  EventLoopGameWindow.prototype.constructor = EventLoopGameWindow;
  ...
  function AG() {
    ...
    this.maxTextureSize_6yxley$_0 = Size.Companion.invoke_vux9f0$(2048, 2048);
    ...
    this.batch_kwvgns$_0 = new AG$Batch();
  ...
  AG.prototype.draw_36194n$ = function (vertices, program, type, vertexLayout, vertexCount, indices, offset, blending, uniforms, stencil, colorMask, renderState, scissor) {
    if (indices === void 0)
      indices = null;
    if (offset === void 0)
      offset = 0;
    ...
    if (scissor === void 0)
      scissor = null;
    var $receiver = this.batch_kwvgns$_0;
    $receiver.vertices = vertices;
    $receiver.program = program;
    $receiver.type = type;
    $receiver.vertexLayout = vertexLayout;
    $receiver.vertexCount = vertexCount;
    $receiver.indices = indices;
    $receiver.offset = offset;
    $receiver.blending = blending;
    $receiver.uniforms = uniforms;
    $receiver.stencil = stencil;
    $receiver.colorMask = colorMask;
    $receiver.renderState = renderState;
    $receiver.scissor = scissor;
    this.draw_y6md32$($receiver);
  };
  function AG$Batch() {
    this.vertices = new AG$Buffer(AG$Buffer$Kind$VERTEX_getInstance());
    this.program = DefaultShaders_getInstance().PROGRAM_DEBUG;
    this.type = AG$DrawType$TRIANGLES_getInstance();
    this.vertexLayout = VertexLayout_init_0([]);
    this.vertexCount = 0;
    this.indices = null;
    this.offset = 0;
    this.blending = AG$Blending$Companion_getInstance().NORMAL;
    this.uniforms = AG$UniformValues$Companion_getInstance().EMPTY_8be2vx$;
    this.stencil = new AG$StencilState();
    this.colorMask = new AG$ColorMaskState();
    this.renderState = new AG$RenderState();
    this.scissor = null;
  }
  AG$Batch.$metadata$ = {
    kind: Kind_CLASS,
  ...
  AG.prototype.draw_y6md32$ = function (batch) {
  };
  ...
  function AGOpengl$ShaderException(str, error, errorInt, gl) {
    RuntimeException_init('Error Compiling Shader : ' + errorInt + " : '" + error + "' : source='" + str + "', gl.versionInt=" + get_versionInt(gl) + ", gl.versionString='" + get_versionString(gl) + "', gl=" + gl, this);
    this.str = str;
    this.error = error;
    this.errorInt = errorInt;
    this.gl = gl;
    this.name = 'AGOpengl$ShaderException';
  }
  AGOpengl$ShaderException.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ShaderException',
    interfaces: [RuntimeException]
  };
  ...
  AGOpengl.prototype.draw_y6md32$ = function (batch) {
    ...
    var type = batch.type;
    var vertexLayout = batch.vertexLayout;
    var vertexCount = batch.vertexCount;
    var indices = batch.indices;
    var offset = batch.offset;
    var blending = batch.blending;
    var uniforms = batch.uniforms;
    var stencil = batch.stencil;
    var colorMask = batch.colorMask;
  ...
  AGOpengl$GlProgram.prototype.createShaderCompat_0 = function (type, gen) {
    var tmp$;
    try {
      tmp$ = this.createShader_0(type, gen(true));
    } catch (e) {
      if (Kotlin.isType(e, AGOpengl$ShaderException)) {
        tmp$ = this.createShader_0(type, gen(false));
      } else
        throw e;
    }
    return tmp$;
  ...
  AGOpengl$GlProgram.prototype.ensure_0 = function () {
    ...
    if (this.cachedVersion !== this.$outer.contextVersion) {
      ...
      var guessedGlSlVersion = (tmp$ = this.$outer.glSlVersion) != null ? tmp$ : get_versionInt(this.gl);
      tmp$_2 = (tmp$_0 = GlslGenerator$Companion_getInstance().FORCE_GLSL_VERSION) != null ? toIntOrNull(tmp$_0) : null;
      if (tmp$_2 == null) {
        if (guessedGlSlVersion === 460)
          tmp$_1 = 460;
        else if (guessedGlSlVersion >= 300 && guessedGlSlVersion <= 450)
          tmp$_1 = 100;
        else
          tmp$_1 = guessedGlSlVersion;
        tmp$_2 = tmp$_1;
      }var usedGlSlVersion = tmp$_2;
      if (GlslGenerator$Companion_getInstance().DEBUG_GLSL) {
        println('GLSL version: requested=' + toString(this.$outer.glSlVersion) + ', guessed=' + guessedGlSlVersion + ', forced=' + toString(GlslGenerator$Companion_getInstance().FORCE_GLSL_VERSION) + '. used=' + usedGlSlVersion);
      }var type = this.gl.FRAGMENT_SHADER;
      this.$outer;
      var tmp$_3;
      try {
        tmp$_3 = this.createShader_0(type, toNewGlslStringResult(this.program.fragment, this.$outer.gles, usedGlSlVersion, true).result);
      } catch (e) {
        if (Kotlin.isType(e, AGOpengl$ShaderException)) {
          tmp$_3 = this.createShader_0(type, toNewGlslStringResult(this.program.fragment, this.$outer.gles, usedGlSlVersion, false).result);
        } else
          throw e;
      }
      this.fragmentShaderId = tmp$_3;
      var type_0 = this.gl.VERTEX_SHADER;
      this.$outer;
      var tmp$_4;
      try {
        tmp$_4 = this.createShader_0(type_0, toNewGlslStringResult(this.program.vertex, this.$outer.gles, usedGlSlVersion, true).result);
      } catch (e_0) {
        if (Kotlin.isType(e_0, AGOpengl$ShaderException)) {
          tmp$_4 = this.createShader_0(type_0, toNewGlslStringResult(this.program.vertex, this.$outer.gles, usedGlSlVersion, false).result);
        } else
          throw e_0;
      }
      this.vertexShaderId = tmp$_4;
  ...
  AGOpengl$GlProgram.prototype.createShader_0 = function (type, str) {
    ...
    if (out !== this.gl.TRUE) {
      ...
      throw new AGOpengl$ShaderException(str, error, errorInt, this.gl);
    }return shaderId;
  };
  ...
  LogAG.prototype.draw_y6md32$ = function (batch) {
  ...
  function toNewGlslString($receiver, gles, version, compatibility) {
    if (gles === void 0)
      gles = true;
    if (version === void 0)
      version = GlslGenerator$Companion_getInstance().DEFAULT_VERSION;
    if (compatibility === void 0)
      compatibility = true;
    return (new GlslGenerator($receiver.type, gles, version, compatibility)).generate_57b21j$($receiver.stm);
  }
  function toNewGlslStringResult($receiver, gles, version, compatibility) {
    if (gles === void 0)
      gles = true;
    if (version === void 0)
      version = GlslGenerator$Companion_getInstance().DEFAULT_VERSION;
    if (compatibility === void 0)
      compatibility = true;
    return (new GlslGenerator($receiver.type, gles, version, compatibility)).generateResult_57b21j$($receiver.stm);
  }
  function toGlSlString($receiver, gles, compatibility) {
    if (gles === void 0)
      gles = true;
    if (compatibility === void 0)
      compatibility = true;
    return (new GlslGenerator(ShaderType$VERTEX_getInstance(), gles, void 0, compatibility)).generate_57b21j$($receiver.stm);
  }
  function toGlSlString_0($receiver, gles, compatibility) {
    if (gles === void 0)
      gles = true;
    if (compatibility === void 0)
      compatibility = true;
    return (new GlslGenerator(ShaderType$FRAGMENT_getInstance(), gles, void 0, compatibility)).generate_57b21j$($receiver.stm);
  }
  function GlslGenerator(kind, gles, version, compatibility) {
    ...
    this.newGlSlVersion = false;
    this.IN = this.newGlSlVersion ? 'in' : 'attribute';
    this.OUT = this.newGlSlVersion ? 'out' : 'varying';
    this.UNIFORM = 'uniform';
    this.gl_FragColor = this.newGlSlVersion ? GlslGenerator$Companion_getInstance().FRAGCOLOR : GlslGenerator$Companion_getInstance().GL_FRAGCOLOR;
    this.temps_0 = LinkedHashSet_init();
    this.attributes_0 = LinkedHashSet_init();
    this.varyings_0 = LinkedHashSet_init();
    this.uniforms_0 = LinkedHashSet_init();
    this.programIndenter_0 = new Indenter();
  }
  function GlslGenerator$Companion() {
    GlslGenerator$Companion_instance = this;
    this.DEFAULT_VERSION = 100;
    this.FRAGCOLOR = 'fragColor';
    this.GL_FRAGCOLOR = 'gl_FragColor';
  }
  Object.defineProperty(GlslGenerator$Companion.prototype, 'FORCE_GLSL_VERSION', {
    get: function () {
      return lang.Environment.get_61zpoe$('FORCE_GLSL_VERSION');
    }
  });
  Object.defineProperty(GlslGenerator$Companion.prototype, 'DEBUG_GLSL', {
    get: function () {
      return equals(lang.Environment.get_61zpoe$('DEBUG_GLSL'), 'true');
    }
  });
  ...
  function GlslGenerator$Result(generator, result, attributes, uniforms, varyings) {
  ...
  GlslGenerator$Result.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Result',
    interfaces: []
  };
  GlslGenerator$Result.prototype.component1 = function () {
    return this.generator;
  };
  GlslGenerator$Result.prototype.component2 = function () {
    return this.result;
  };
  GlslGenerator$Result.prototype.component3 = function () {
    return this.attributes;
  };
  GlslGenerator$Result.prototype.component4 = function () {
    return this.uniforms;
  };
  GlslGenerator$Result.prototype.component5 = function () {
    return this.varyings;
  };
  GlslGenerator$Result.prototype.copy_ewkg9b$ = function (generator, result, attributes, uniforms, varyings) {
    return new GlslGenerator$Result(generator === void 0 ? this.generator : generator, result === void 0 ? this.result : result, attributes === void 0 ? this.attributes : attributes, uniforms === void 0 ? this.uniforms : uniforms, varyings === void 0 ? this.varyings : varyings);
  };
  GlslGenerator$Result.prototype.toString = function () {
    return 'Result(generator=' + Kotlin.toString(this.generator) + (', result=' + Kotlin.toString(this.result)) + (', attributes=' + Kotlin.toString(this.attributes)) + (', uniforms=' + Kotlin.toString(this.uniforms)) + (', varyings=' + Kotlin.toString(this.varyings)) + ')';
  };
  GlslGenerator$Result.prototype.hashCode = function () {
    var result = 0;
    ...
    result = result * 31 + Kotlin.hashCode(this.uniforms) | 0;
    result = result * 31 + Kotlin.hashCode(this.varyings) | 0;
    return result;
  };
  GlslGenerator$Result.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.generator, other.generator) && Kotlin.equals(this.result, other.result) && Kotlin.equals(this.attributes, other.attributes) && Kotlin.equals(this.uniforms, other.uniforms) && Kotlin.equals(this.varyings, other.varyings)))));
  };
  function GlslGenerator$generateResult$lambda(this$GlslGenerator) {
    return function ($receiver) {
      var tmp$, tmp$_0, tmp$_1;
      if (this$GlslGenerator.gles) {
        if (this$GlslGenerator.compatibility) {
          $receiver.line_61zpoe$('#version ' + this$GlslGenerator.version + ' compatibility');
        } else {
      ...
      while (tmp$.hasNext()) {
        var it = tmp$.next();
        $receiver.line_61zpoe$(this$GlslGenerator.IN + ' ' + this$GlslGenerator.typeToString_b2kxjc$(it.type) + ' ' + it.name + this$GlslGenerator.get_arrayDecl_55mpc6$(it) + ';');
      }
      tmp$_0 = this$GlslGenerator.uniforms_0.iterator();
      while (tmp$_0.hasNext()) {
        var it_0 = tmp$_0.next();
        $receiver.line_61zpoe$(this$GlslGenerator.UNIFORM + ' ' + this$GlslGenerator.typeToString_b2kxjc$(it_0.type) + ' ' + it_0.name + this$GlslGenerator.get_arrayDecl_55mpc6$(it_0) + ';');
      }
      tmp$_1 = this$GlslGenerator.varyings_0.iterator();
      while (tmp$_1.hasNext()) {
        var it_1 = tmp$_1.next();
        if (this$GlslGenerator.newGlSlVersion && equals(it_1.name, this$GlslGenerator.gl_FragColor)) {
          $receiver.line_61zpoe$('layout(location=0) ' + this$GlslGenerator.OUT + ' ' + this$GlslGenerator.typeToString_b2kxjc$(it_1.type) + ' ' + it_1.name + ';');
        } else {
          $receiver.line_61zpoe$(this$GlslGenerator.OUT + ' ' + this$GlslGenerator.typeToString_b2kxjc$(it_1.type) + ' ' + it_1.name + ';');
        }
      }
      var str = 'void main()';
  ...
  GlslGenerator.prototype.generateResult_57b21j$ = function (root) {
    this.temps_0.clear();
    this.attributes_0.clear();
    this.varyings_0.clear();
    this.uniforms_0.clear();
    this.programIndenter_0 = new Indenter();
    if (this.kind === ShaderType$FRAGMENT_getInstance() && this.newGlSlVersion) {
      this.varyings_0.add_11rb$(Varying_init(this.gl_FragColor, VarType$Float4_getInstance()));
    ...
    }var $receiver = Indenter.Companion.invoke_z3r7a6$(GlslGenerator$generateResult$lambda(this)).toString();
    if (GlslGenerator$Companion_getInstance().DEBUG_GLSL) {
      println('GlSlGenerator.version: ' + this.version);
      println('GlSlGenerator:' + '\n' + $receiver);
    }var result = $receiver;
    return new GlslGenerator$Result(this, result, toList(this.attributes_0), toList(this.uniforms_0), toList(this.varyings_0));
  };
  GlslGenerator.prototype.generate_57b21j$ = function (root) {
    return this.generateResult_57b21j$(root).result;
  };
  ...
  function Operand(type) {
    this.type_91l9jy$_0 = type;
  }
  Object.defineProperty(Operand.prototype, 'type', {
    get: function () {
      return this.type_91l9jy$_0;
    }
  });
  Operand.$metadata$ = {
    kind: Kind_CLASS,
  ...
  Variable.prototype.mequals_fr4ev7$ = defineInlineFunction('korgw-root-korgw.com.soywiz.korag.shader.Variable.mequals_fr4ev7$', wrapFunction(function () {
    var equals = Kotlin.equals;
    return function (T_0, isT, other) {
      return isT(other) && this.id === other.id && this.type === other.type && this.arrayCount === other.arrayCount && equals(this.name, other.name);
    };
  }));
  Variable.prototype.mhashcode = defineInlineFunction('korgw-root-korgw.com.soywiz.korag.shader.Variable.mhashcode', wrapFunction(function () {
    var hashCode = Kotlin.hashCode;
    return function () {
      return hashCode(this.id) + (this.type.hashCode() * 7 | 0) + (hashCode(this.name) * 11 | 0) | 0;
    };
  }));
  Variable.prototype.equals = function (other) {
    return Kotlin.isType(other, Variable) && this.id === other.id && this.type === other.type && this.arrayCount === other.arrayCount && equals(this.name, other.name);
  };
  ...
  Attribute.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, Attribute) && this.id === other.id && this.type === other.type && this.arrayCount === other.arrayCount && equals(this.name, other.name) && this.normalized === (Kotlin.isType(tmp$ = other, Attribute) ? tmp$ : throwCCE()).normalized && this.offset == other.offset && this.active === other.active;
  };
  Attribute.prototype.hashCode = function () {
    var out = hashCode(this.id) + (this.type.hashCode() * 7 | 0) + (hashCode(this.name) * 11 | 0) | 0;
    out = out * 7 | 0;
    out = out + hashCode(this.normalized) | 0;
    out = out * 7 | 0;
    var $receiver = this.offset;
    var tmp$;
    out = out + ((tmp$ = $receiver != null ? hashCode($receiver) : null) != null ? tmp$ : 0) | 0;
    out = out * 7 | 0;
    out = out + hashCode(this.active) | 0;
    return out;
  };
  Attribute.$metadata$ = {
    kind: Kind_CLASS,
  ...
  Varying.prototype.equals = function (other) {
    return Kotlin.isType(other, Varying) && this.id === other.id && this.type === other.type && this.arrayCount === other.arrayCount && equals(this.name, other.name);
  };
  ...
  Uniform.prototype.equals = function (other) {
    return Kotlin.isType(other, Uniform) && this.id === other.id && this.type === other.type && this.arrayCount === other.arrayCount && equals(this.name, other.name);
  };
  ...
  Temp.prototype.equals = function (other) {
    return Kotlin.isType(other, Temp) && this.id === other.id && this.type === other.type && this.arrayCount === other.arrayCount && equals(this.name, other.name);
  };
  ...
  Output.prototype.equals = function (other) {
    return Kotlin.isType(other, Output) && this.id === other.id && this.type === other.type && this.arrayCount === other.arrayCount && equals(this.name, other.name);
  };
  ...
  Program.prototype.hashCode = function () {
    return (this.vertex.hashCode() * 11 | 0) + (this.fragment.hashCode() * 7 | 0) + hashCode(this.name) | 0;
  };
  Program.prototype.equals = function (other) {
    var tmp$, tmp$_0;
    return Kotlin.isType(other, Program) && ((tmp$ = this.vertex) != null ? tmp$.equals(other.vertex) : null) && ((tmp$_0 = this.fragment) != null ? tmp$_0.equals(other.fragment) : null) && equals(this.name, other.name);
  };
  ...
  Program$Binop.prototype.component1 = function () {
    return this.left;
  };
  Program$Binop.prototype.component2 = function () {
    return this.op;
  };
  Program$Binop.prototype.component3 = function () {
    return this.right;
  };
  Program$Binop.prototype.copy_q02l4q$ = function (left, op, right) {
    return new Program$Binop(left === void 0 ? this.left : left, op === void 0 ? this.op : op, right === void 0 ? this.right : right);
  };
  Program$Binop.prototype.toString = function () {
    return 'Binop(left=' + Kotlin.toString(this.left) + (', op=' + Kotlin.toString(this.op)) + (', right=' + Kotlin.toString(this.right)) + ')';
  };
  Program$Binop.prototype.hashCode = function () {
    var result = 0;
  ...
  Program$Binop.prototype.equals = function (other) {
  ...
  Program$IntLiteral.prototype.component1 = function () {
    return this.value;
  };
  Program$IntLiteral.prototype.copy_za3lpa$ = function (value) {
    return new Program$IntLiteral(value === void 0 ? this.value : value);
  };
  Program$IntLiteral.prototype.toString = function () {
    return 'IntLiteral(value=' + Kotlin.toString(this.value) + ')';
  };
  Program$IntLiteral.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.value) | 0;
    return result;
  };
  Program$IntLiteral.prototype.equals = function (other) {
  ...
  Program$FloatLiteral.prototype.component1 = function () {
    return this.value;
  };
  Program$FloatLiteral.prototype.copy_mx4ult$ = function (value) {
    return new Program$FloatLiteral(value === void 0 ? this.value : value);
  };
  Program$FloatLiteral.prototype.toString = function () {
    return 'FloatLiteral(value=' + Kotlin.toString(this.value) + ')';
  };
  Program$FloatLiteral.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.value) | 0;
    return result;
  };
  Program$FloatLiteral.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && Kotlin.equals(this.value, other.value))));
  };
  ...
  Program$BoolLiteral.prototype.component1 = function () {
    return this.value;
  };
  Program$BoolLiteral.prototype.copy_6taknv$ = function (value) {
    return new Program$BoolLiteral(value === void 0 ? this.value : value);
  };
  Program$BoolLiteral.prototype.toString = function () {
    return 'BoolLiteral(value=' + Kotlin.toString(this.value) + ')';
  };
  Program$BoolLiteral.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.value) | 0;
    return result;
  };
  Program$BoolLiteral.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && Kotlin.equals(this.value, other.value))));
  };
  function Program$Vector(type, ops) {
    Operand.call(this, type);
    this.type_24nfpk$_0 = type;
    this.ops = ops;
  }
  Object.defineProperty(Program$Vector.prototype, 'type', {
    get: function () {
      return this.type_24nfpk$_0;
    }
  });
  Program$Vector.prototype.equals = function (other) {
    return Kotlin.isType(other, Program$Vector) && this.type === other.type && contentEquals(this.ops, other.ops);
  };
  Program$Vector.prototype.hashCode = function () {
    return (this.type.hashCode() * 7 | 0) + contentHashCode(this.ops) | 0;
  };
  ...
  Program$Vector.prototype.component1 = function () {
    return this.type;
  };
  Program$Vector.prototype.component2 = function () {
    return this.ops;
  };
  Program$Vector.prototype.copy_9ukvpi$ = function (type, ops) {
    return new Program$Vector(type === void 0 ? this.type : type, ops === void 0 ? this.ops : ops);
  };
  Program$Vector.prototype.toString = function () {
    return 'Vector(type=' + Kotlin.toString(this.type) + (', ops=' + Kotlin.toString(this.ops)) + ')';
  };
  ...
  Program$Swizzle.prototype.component1 = function () {
    return this.left;
  };
  Program$Swizzle.prototype.component2 = function () {
    return this.swizzle;
  };
  Program$Swizzle.prototype.copy_sgnm8u$ = function (left, swizzle) {
    return new Program$Swizzle(left === void 0 ? this.left : left, swizzle === void 0 ? this.swizzle : swizzle);
  };
  Program$Swizzle.prototype.toString = function () {
    return 'Swizzle(left=' + Kotlin.toString(this.left) + (', swizzle=' + Kotlin.toString(this.swizzle)) + ')';
  };
  Program$Swizzle.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.left) | 0;
    result = result * 31 + Kotlin.hashCode(this.swizzle) | 0;
    return result;
  };
  Program$Swizzle.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.left, other.left) && Kotlin.equals(this.swizzle, other.swizzle)))));
  };
  ...
  Program$ArrayAccess.prototype.component1 = function () {
    return this.left;
  };
  Program$ArrayAccess.prototype.component2 = function () {
    return this.index;
  };
  Program$ArrayAccess.prototype.copy_q0hzsk$ = function (left, index) {
    return new Program$ArrayAccess(left === void 0 ? this.left : left, index === void 0 ? this.index : index);
  };
  Program$ArrayAccess.prototype.toString = function () {
    return 'ArrayAccess(left=' + Kotlin.toString(this.left) + (', index=' + Kotlin.toString(this.index)) + ')';
  };
  Program$ArrayAccess.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.left) | 0;
    result = result * 31 + Kotlin.hashCode(this.index) | 0;
    return result;
  };
  Program$ArrayAccess.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.left, other.left) && Kotlin.equals(this.index, other.index)))));
  };
  ...
  function Program$Program$Func_init(name, ops, $this) {
    ...
    Program$Func.call($this, name, toList_0(ops));
    return $this;
  }
  Program$Func.prototype.component1 = function () {
    return this.name;
  };
  Program$Func.prototype.component2 = function () {
    return this.ops;
  };
  Program$Func.prototype.copy_v1exkj$ = function (name, ops) {
    return new Program$Func(name === void 0 ? this.name : name, ops === void 0 ? this.ops : ops);
  };
  Program$Func.prototype.toString = function () {
    return 'Func(name=' + Kotlin.toString(this.name) + (', ops=' + Kotlin.toString(this.ops)) + ')';
  };
  Program$Func.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.name) | 0;
    result = result * 31 + Kotlin.hashCode(this.ops) | 0;
    return result;
  };
  Program$Func.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.name, other.name) && Kotlin.equals(this.ops, other.ops)))));
  };
  ...
  Program$Stm$Stms.prototype.component1 = function () {
    return this.stms;
  };
  Program$Stm$Stms.prototype.copy_clanmw$ = function (stms) {
    return new Program$Stm$Stms(stms === void 0 ? this.stms : stms);
  };
  Program$Stm$Stms.prototype.toString = function () {
    return 'Stms(stms=' + Kotlin.toString(this.stms) + ')';
  };
  Program$Stm$Stms.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.stms) | 0;
    return result;
  };
  Program$Stm$Stms.prototype.equals = function (other) {
  ...
  Program$Stm$Set.prototype.component1 = function () {
    return this.to;
  };
  Program$Stm$Set.prototype.component2 = function () {
    return this.from;
  };
  Program$Stm$Set.prototype.copy_q0hzsk$ = function (to, from) {
    return new Program$Stm$Set(to === void 0 ? this.to : to, from === void 0 ? this.from : from);
  };
  Program$Stm$Set.prototype.toString = function () {
    return 'Set(to=' + Kotlin.toString(this.to) + (', from=' + Kotlin.toString(this.from)) + ')';
  };
  Program$Stm$Set.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.to) | 0;
    result = result * 31 + Kotlin.hashCode(this.from) | 0;
    return result;
  };
  Program$Stm$Set.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.to, other.to) && Kotlin.equals(this.from, other.from)))));
  };
  function Program$Stm$Discard() {
    Program$Stm.call(this);
  }
  Program$Stm$Discard.prototype.equals = function (other) {
    return Kotlin.isType(other, Program$Stm$Discard);
  };
  Program$Stm$Discard.prototype.hashCode = function () {
    return 1;
  };
  ...
  Program$Stm$If.prototype.component1 = function () {
    return this.cond;
  };
  Program$Stm$If.prototype.component2 = function () {
    return this.tbody;
  };
  Program$Stm$If.prototype.component3 = function () {
    return this.fbody;
  };
  Program$Stm$If.prototype.copy_atlhit$ = function (cond, tbody, fbody) {
    return new Program$Stm$If(cond === void 0 ? this.cond : cond, tbody === void 0 ? this.tbody : tbody, fbody === void 0 ? this.fbody : fbody);
  };
  Program$Stm$If.prototype.toString = function () {
    return 'If(cond=' + Kotlin.toString(this.cond) + (', tbody=' + Kotlin.toString(this.tbody)) + (', fbody=' + Kotlin.toString(this.fbody)) + ')';
  };
  Program$Stm$If.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.cond) | 0;
    result = result * 31 + Kotlin.hashCode(this.tbody) | 0;
    result = result * 31 + Kotlin.hashCode(this.fbody) | 0;
    return result;
  };
  Program$Stm$If.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.cond, other.cond) && Kotlin.equals(this.tbody, other.tbody) && Kotlin.equals(this.fbody, other.fbody)))));
  };
  ...
  function Shader(type, stm) {
    this.type = type;
    this.stm = stm;
    this.stmHashCode_annp0j$_0 = hashCode(this.stm);
  ...
  Shader.prototype.equals = function (other) {
    return Kotlin.isType(other, Shader) && this.type === other.type && this.stmHashCode_annp0j$_0 === other.stmHashCode_annp0j$_0 && equals(this.stm, other.stm);
  };
  Shader.prototype.hashCode = function () {
    return (this.type.hashCode() * 17 | 0) + this.stmHashCode_annp0j$_0 | 0;
  };
  ...
  function VertexLayout_init_0(attributes, $this) {
    $this = $this || Object.create(VertexLayout.prototype);
    VertexLayout.call($this, toList_0(attributes), null);
    return $this;
  }
  function VertexLayout_init_1(attributes, layoutSize, $this) {
    if (layoutSize === void 0)
      layoutSize = null;
    $this = $this || Object.create(VertexLayout.prototype);
    VertexLayout.call($this, toList_0(attributes), layoutSize);
    return $this;
  }
  ...
  Touch.prototype.copyFrom_kl8l8a$ = function (other) {
    ...
    this.start.copyFrom_4l17gg$(other.start);
    this.current.copyFrom_4l17gg$(other.current);
  };
  ...
  function MouseButton_initFields() {
    ...
    MouseButton$MIDDLE_instance = new MouseButton('MIDDLE', 1, 1);
    MouseButton$RIGHT_instance = new MouseButton('RIGHT', 2, 2);
    ...
    MouseButton$BUTTON6_instance = new MouseButton('BUTTON6', 6, 6);
    MouseButton$BUTTON7_instance = new MouseButton('BUTTON7', 7, 7);
    MouseButton$BUTTON_UNKNOWN_instance = new MouseButton('BUTTON_UNKNOWN', 8, 8);
  ...
  var MouseButton$BUTTON6_instance;
  function MouseButton$BUTTON6_getInstance() {
    MouseButton_initFields();
    return MouseButton$BUTTON6_instance;
  }
  var MouseButton$BUTTON7_instance;
  function MouseButton$BUTTON7_getInstance() {
    MouseButton_initFields();
    return MouseButton$BUTTON7_instance;
  }
  ...
  function MouseButton$values() {
    return [MouseButton$LEFT_getInstance(), MouseButton$MIDDLE_getInstance(), MouseButton$RIGHT_getInstance(), MouseButton$BUTTON3_getInstance(), MouseButton$BUTTON4_getInstance(), MouseButton$BUTTON5_getInstance(), MouseButton$BUTTON6_getInstance(), MouseButton$BUTTON7_getInstance(), MouseButton$BUTTON_UNKNOWN_getInstance()];
  }
  ...
  function MouseButton$valueOf(name) {
    switch (name) {
      ...
      case 'BUTTON6':
        return MouseButton$BUTTON6_getInstance();
      case 'BUTTON7':
        return MouseButton$BUTTON7_getInstance();
      case 'BUTTON_UNKNOWN':
  ...
  function Key_initFields() {
    ...
    Key$PLUS_instance = new Key('PLUS', 4);
    Key$PERIOD_instance = new Key('PERIOD', 5);
    Key$SLASH_instance = new Key('SLASH', 6);
    Key$N0_instance = new Key('N0', 7);
    Key$N1_instance = new Key('N1', 8);
    Key$N2_instance = new Key('N2', 9);
    Key$N3_instance = new Key('N3', 10);
    Key$N4_instance = new Key('N4', 11);
    Key$N5_instance = new Key('N5', 12);
    Key$N6_instance = new Key('N6', 13);
    Key$N7_instance = new Key('N7', 14);
    Key$N8_instance = new Key('N8', 15);
    Key$N9_instance = new Key('N9', 16);
    Key$SEMICOLON_instance = new Key('SEMICOLON', 17);
    Key$EQUAL_instance = new Key('EQUAL', 18);
    Key$A_instance = new Key('A', 19);
    Key$B_instance = new Key('B', 20);
    Key$C_instance = new Key('C', 21);
    Key$D_instance = new Key('D', 22);
    Key$E_instance = new Key('E', 23);
    Key$F_instance = new Key('F', 24);
    Key$G_instance = new Key('G', 25);
    Key$H_instance = new Key('H', 26);
    Key$I_instance = new Key('I', 27);
    Key$J_instance = new Key('J', 28);
    Key$K_instance = new Key('K', 29);
    Key$L_instance = new Key('L', 30);
    Key$M_instance = new Key('M', 31);
    Key$N_instance = new Key('N', 32);
    Key$O_instance = new Key('O', 33);
    Key$P_instance = new Key('P', 34);
    Key$Q_instance = new Key('Q', 35);
    Key$R_instance = new Key('R', 36);
    Key$S_instance = new Key('S', 37);
    Key$T_instance = new Key('T', 38);
    Key$U_instance = new Key('U', 39);
    Key$V_instance = new Key('V', 40);
    Key$W_instance = new Key('W', 41);
    Key$X_instance = new Key('X', 42);
    Key$Y_instance = new Key('Y', 43);
    Key$Z_instance = new Key('Z', 44);
    Key$LEFT_BRACKET_instance = new Key('LEFT_BRACKET', 45);
    Key$BACKSLASH_instance = new Key('BACKSLASH', 46);
    Key$RIGHT_BRACKET_instance = new Key('RIGHT_BRACKET', 47);
    Key$GRAVE_ACCENT_instance = new Key('GRAVE_ACCENT', 48);
    Key$WORLD_1_instance = new Key('WORLD_1', 49);
    Key$WORLD_2_instance = new Key('WORLD_2', 50);
    Key$ESCAPE_instance = new Key('ESCAPE', 51);
    Key$META_instance = new Key('META', 52);
    Key$ENTER_instance = new Key('ENTER', 53);
    Key$TAB_instance = new Key('TAB', 54);
    Key$BACKSPACE_instance = new Key('BACKSPACE', 55);
    Key$INSERT_instance = new Key('INSERT', 56);
    Key$DELETE_instance = new Key('DELETE', 57);
    Key$RIGHT_instance = new Key('RIGHT', 58);
    Key$LEFT_instance = new Key('LEFT', 59);
    Key$DOWN_instance = new Key('DOWN', 60);
    Key$UP_instance = new Key('UP', 61);
    Key$PAGE_UP_instance = new Key('PAGE_UP', 62);
    Key$PAGE_DOWN_instance = new Key('PAGE_DOWN', 63);
    Key$FUNCTION_instance = new Key('FUNCTION', 64);
    Key$HELP_instance = new Key('HELP', 65);
    Key$MUTE_instance = new Key('MUTE', 66);
    Key$VOLUME_DOWN_instance = new Key('VOLUME_DOWN', 67);
    Key$VOLUME_UP_instance = new Key('VOLUME_UP', 68);
    Key$HOME_instance = new Key('HOME', 69);
    Key$END_instance = new Key('END', 70);
    Key$CAPS_LOCK_instance = new Key('CAPS_LOCK', 71);
    Key$SCROLL_LOCK_instance = new Key('SCROLL_LOCK', 72);
    Key$NUM_LOCK_instance = new Key('NUM_LOCK', 73);
    Key$PRINT_SCREEN_instance = new Key('PRINT_SCREEN', 74);
    Key$PAUSE_instance = new Key('PAUSE', 75);
    Key$F1_instance = new Key('F1', 76);
    Key$F2_instance = new Key('F2', 77);
    Key$F3_instance = new Key('F3', 78);
    Key$F4_instance = new Key('F4', 79);
    Key$F5_instance = new Key('F5', 80);
    Key$F6_instance = new Key('F6', 81);
    Key$F7_instance = new Key('F7', 82);
    Key$F8_instance = new Key('F8', 83);
    Key$F9_instance = new Key('F9', 84);
    Key$F10_instance = new Key('F10', 85);
    Key$F11_instance = new Key('F11', 86);
    Key$F12_instance = new Key('F12', 87);
    Key$F13_instance = new Key('F13', 88);
    Key$F14_instance = new Key('F14', 89);
    Key$F15_instance = new Key('F15', 90);
    Key$F16_instance = new Key('F16', 91);
    Key$F17_instance = new Key('F17', 92);
    Key$F18_instance = new Key('F18', 93);
    Key$F19_instance = new Key('F19', 94);
    Key$F20_instance = new Key('F20', 95);
    Key$F21_instance = new Key('F21', 96);
    Key$F22_instance = new Key('F22', 97);
    Key$F23_instance = new Key('F23', 98);
    Key$F24_instance = new Key('F24', 99);
    Key$F25_instance = new Key('F25', 100);
    Key$KP_0_instance = new Key('KP_0', 101);
    Key$KP_1_instance = new Key('KP_1', 102);
    Key$KP_2_instance = new Key('KP_2', 103);
    Key$KP_3_instance = new Key('KP_3', 104);
    Key$KP_4_instance = new Key('KP_4', 105);
    Key$KP_5_instance = new Key('KP_5', 106);
    Key$KP_6_instance = new Key('KP_6', 107);
    Key$KP_7_instance = new Key('KP_7', 108);
    Key$KP_8_instance = new Key('KP_8', 109);
    Key$KP_9_instance = new Key('KP_9', 110);
    Key$KP_DECIMAL_instance = new Key('KP_DECIMAL', 111);
    Key$KP_DIVIDE_instance = new Key('KP_DIVIDE', 112);
    Key$KP_MULTIPLY_instance = new Key('KP_MULTIPLY', 113);
    Key$KP_SUBTRACT_instance = new Key('KP_SUBTRACT', 114);
    Key$KP_ADD_instance = new Key('KP_ADD', 115);
    Key$KP_ENTER_instance = new Key('KP_ENTER', 116);
    Key$KP_EQUAL_instance = new Key('KP_EQUAL', 117);
    Key$KP_SEPARATOR_instance = new Key('KP_SEPARATOR', 118);
    Key$LEFT_SHIFT_instance = new Key('LEFT_SHIFT', 119);
    Key$LEFT_CONTROL_instance = new Key('LEFT_CONTROL', 120);
    Key$LEFT_ALT_instance = new Key('LEFT_ALT', 121);
    Key$LEFT_SUPER_instance = new Key('LEFT_SUPER', 122);
    Key$RIGHT_SHIFT_instance = new Key('RIGHT_SHIFT', 123);
    Key$RIGHT_CONTROL_instance = new Key('RIGHT_CONTROL', 124);
    Key$RIGHT_ALT_instance = new Key('RIGHT_ALT', 125);
    Key$RIGHT_SUPER_instance = new Key('RIGHT_SUPER', 126);
    Key$MENU_instance = new Key('MENU', 127);
    Key$BACKQUOTE_instance = new Key('BACKQUOTE', 128);
    Key$QUOTE_instance = new Key('QUOTE', 129);
    Key$KP_UP_instance = new Key('KP_UP', 130);
    Key$KP_DOWN_instance = new Key('KP_DOWN', 131);
    Key$KP_LEFT_instance = new Key('KP_LEFT', 132);
    Key$KP_RIGHT_instance = new Key('KP_RIGHT', 133);
    Key$UNDERLINE_instance = new Key('UNDERLINE', 134);
    Key$SELECT_KEY_instance = new Key('SELECT_KEY', 135);
    Key$CANCEL_instance = new Key('CANCEL', 136);
    Key$CLEAR_instance = new Key('CLEAR', 137);
    Key$OPEN_BRACKET_instance = new Key('OPEN_BRACKET', 138);
    Key$CLOSE_BRACKET_instance = new Key('CLOSE_BRACKET', 139);
    Key$UNDEFINED_instance = new Key('UNDEFINED', 140);
    Key$UNKNOWN_instance = new Key('UNKNOWN', 141);
  ...
  function GameWindowCoroutineDispatcherSetNow() {
    GameWindowCoroutineDispatcher.call(this);
    this.currentTime = klock.PerformanceCounter.hr;
  }
  GameWindowCoroutineDispatcherSetNow.prototype.now = function () {
    return this.currentTime;
  };
  GameWindowCoroutineDispatcherSetNow.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'GameWindowCoroutineDispatcherSetNow',
    interfaces: [GameWindowCoroutineDispatcher]
  };
  function GameWindowCoroutineDispatcher() {
    CoroutineDispatcher.call(this);
    this.tasks = new TGenQueue();
    this.timedTasks = TGenPriorityQueue.Companion.invoke_km2rfd$(void 0, GameWindowCoroutineDispatcher$timedTasks$lambda);
  }
  ...
  GameWindowCoroutineDispatcher.prototype.now = function () {
    return klock.PerformanceCounter.hr;
  };
  GameWindowCoroutineDispatcher.prototype.scheduleResumeAfterDelay_egqmvs$ = function (timeMillis, continuation) {
    this.scheduleResumeAfterDelay_mza3h6$(get_hrMilliseconds(timeMillis.toNumber()), continuation);
  };
  ...
  GameWindowCoroutineDispatcher.prototype.scheduleResumeAfterDelay_mza3h6$ = function (time, continuation) {
    var task = new GameWindowCoroutineDispatcher$TimedTask(this.now().plus_seyb0p$(time), continuation, null);
  ...
  GameWindowCoroutineDispatcher.prototype.invokeOnTimeout_8irseu$ = function (timeMillis, block) {
    var task = new GameWindowCoroutineDispatcher$TimedTask(this.now().plus_seyb0p$(get_hrMilliseconds(timeMillis.toNumber())), null, block);
    this.timedTasks.add_11rb$(task);
  ...
  GameWindowCoroutineDispatcher.prototype.executePending = function () {
    this.executePending_seyb0p$(get_hrSeconds(1));
  };
  GameWindowCoroutineDispatcher.prototype.executePending_seyb0p$ = function (availableTime) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2;
    try {
      var startTime = this.now();
      while (!this.timedTasks.isEmpty() && startTime.compareTo_11rb$(this.timedTasks.head.time) >= 0) {
        ...
        if (this.now().minus_seyb0p$(startTime).compareTo_11rb$(availableTime) >= 0)
          break;
      }
  ...
  function GameWindow() {
    ...
    this.counterTimePerFrame_okejr$_0 = get_hrNanoseconds(0.0);
    this.fps_e82dz$_0 = 60;
    this.fps = 60;
    this.width_whg6e2$_0 = 0;
    this.height_3p2v0t$_0 = 0;
    this.vsync_w69s33$_0 = true;
  ...
  GameWindow.prototype.getCoroutineDispatcherWithCurrentContext_1fupul$ = function (coroutineContext) {
    return coroutineContext.plus_1fupul$(this.coroutineDispatcher);
  };
  GameWindow.prototype.getCoroutineDispatcherWithCurrentContext = function (continuation) {
    return this.getCoroutineDispatcherWithCurrentContext_1fupul$(continuation.context);
  };
  ...
  GameWindow.prototype._setFps_za3lpa$ = function (fps) {
    return fps <= 0 ? 60 : fps;
  };
  Object.defineProperty(GameWindow.prototype, 'counterTimePerFrame', {
    get: function () {
      return this.counterTimePerFrame_okejr$_0;
    },
    set: function (counterTimePerFrame) {
      this.counterTimePerFrame_okejr$_0 = counterTimePerFrame;
    }
  });
  Object.defineProperty(GameWindow.prototype, 'timePerFrame', {
    get: function () {
      return get_timeSpan(this.counterTimePerFrame);
    }
  });
  Object.defineProperty(GameWindow.prototype, 'fps', {
    ...
    set: function (value) {
      var value_0 = this._setFps_za3lpa$(value);
      this.fps_e82dz$_0 = value_0;
      this.counterTimePerFrame = get_hrMicroseconds(1000000.0 / value_0);
    }
  });
  ...
  Object.defineProperty(GameWindow.prototype, 'vsync', {
    get: function () {
      return this.vsync_w69s33$_0;
    },
    set: function (vsync) {
      this.vsync_w69s33$_0 = vsync;
    }
  });
  Object.defineProperty(GameWindow.prototype, 'bufferWidth', {
    get: function () {
      return this.width;
    }
  });
  Object.defineProperty(GameWindow.prototype, 'bufferHeight', {
    get: function () {
      return this.height;
    }
  });
  ...
  function GameWindow$Quality(name, ordinal) {
    ...
    this.name$ = name;
    this.ordinal$ = ordinal;
    this.UPPER_BOUND_RENDERED_PIXELS_jo5g5y$_0 = 4000000;
  }
  ...
  GameWindow$Quality.prototype.computeTargetScale_bgskq8$ = function (width, height, devicePixelRatio, targetPixels) {
    if (targetPixels === void 0)
      targetPixels = this.UPPER_BOUND_RENDERED_PIXELS_jo5g5y$_0;
    var tmp$;
    loop_label: switch (this.name) {
      case 'PERFORMANCE':
        return 1.0;
      case 'QUALITY':
        return devicePixelRatio;
      case 'AUTOMATIC':
        var $receiver = listOf([devicePixelRatio, 2.0, 1.0]);
        var firstOrNull$result;
        firstOrNull$break: do {
          var tmp$_0;
          tmp$_0 = $receiver.iterator();
          while (tmp$_0.hasNext()) {
            ...
            if (Kotlin.imul(width, height) * element <= targetPixels) {
              firstOrNull$result = element;
              break firstOrNull$break;
            }}
          firstOrNull$result = null;
         ...
         while (false);
        return (tmp$ = firstOrNull$result) != null ? tmp$ : 1.0;
      default:return Kotlin.noWhenBranchMatched();
    }
  };
  ...
  GameWindow.prototype.exit = function () {
    this.close();
  };
  ...
  function Coroutine$waitClose($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$waitClose.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$waitClose.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$waitClose.prototype.constructor = Coroutine$waitClose;
  Coroutine$waitClose.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
          ...
          case 2:
            ...
            this.state_0 = 3;
            this.result_0 = delay_0(get_hrMilliseconds_0(100), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
  ...
  GameWindow.prototype.waitClose = function (continuation_0, suspended) {
    var instance = new Coroutine$waitClose(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.getCoroutineDispatcherWithCurrentContext(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            throw this.exception_0;
          case 2:
            launchImmediately(this.result_0, GameWindow$loop$lambda(this.local$entry, this.$this));
            this.state_0 = 3;
            continue;
          case 3:
            if (!this.$this.running) {
            ...
            var start = klock.PerformanceCounter.hr;
            this.$this.frame();
            var elapsed = klock.PerformanceCounter.hr.minus_seyb0p$(start);
            var available = this.$this.counterTimePerFrame.minus_seyb0p$(elapsed);
            this.state_0 = 4;
            this.result_0 = delay_0(available, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 4:
  ...
  GameWindow.prototype.frame = function () {
    this.frame_kw6xyg$(true);
  };
  GameWindow.prototype.frame_kw6xyg$ = function (doUpdate, startTime) {
    if (startTime === void 0)
      startTime = klock.PerformanceCounter.hr;
    try {
      this.ag.onRender.invoke_11rb$(this.ag);
      this.dispatchRenderEvent_6taknv$(doUpdate);
      if (doUpdate) {
        var elapsed = klock.PerformanceCounter.hr.minus_seyb0p$(startTime);
        var available = this.counterTimePerFrame.minus_seyb0p$(elapsed);
        this.coroutineDispatcher.executePending_seyb0p$(available);
      }} catch (e) {
      if (Kotlin.isType(e, Throwable)) {
  ...
  GameWindow.prototype.dispatchRenderEvent = function () {
    this.dispatchRenderEvent_6taknv$(true);
  };
  GameWindow.prototype.dispatchRenderEvent_6taknv$ = function (update) {
    var $receiver = this.renderEvent;
    $receiver.update = update;
    this.dispatch_nipq8w$(getKClass(RenderEvent), $receiver);
  };
  ...
  function Coroutine$GameWindow$entry$lambda(closure$callback_0, this$GameWindow_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
        ...
        switch (this.state_0) {
          ...
          case 2:
            ...
            if (Kotlin.isType(e, Throwable)) {
              ...
              printStackTrace_0(e);
              return this.local$this$GameWindow.running = false, Unit;
            } else {
              throw e;
            }
  ...
  function GameWindow$entry$lambda(closure$callback_0, this$GameWindow_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$GameWindow$entry$lambda(closure$callback_0, this$GameWindow_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  GameWindow.prototype.entry_g2bo5h$ = function (callback) {
    launch(this.coroutineDispatcher, GameWindow$entry$lambda(callback, this));
  };
  GameWindow.$metadata$ = {
    kind: Kind_CLASS,
  ...
  function EventLoopGameWindow() {
    GameWindow.call(this);
    this.coroutineDispatcher_zcgjan$_0 = new GameWindowCoroutineDispatcherSetNow();
    this.lastRenderTime = klock.PerformanceCounter.hr;
  }
  Object.defineProperty(EventLoopGameWindow.prototype, 'coroutineDispatcher', {
    get: function () {
      return this.coroutineDispatcher_zcgjan$_0;
    }
  });
  function Coroutine$EventLoopGameWindow$loop$lambda(closure$entry_0, this$EventLoopGameWindow_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 5;
    this.local$closure$entry = closure$entry_0;
    this.local$this$EventLoopGameWindow = this$EventLoopGameWindow_0;
  }
  Coroutine$EventLoopGameWindow$loop$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$EventLoopGameWindow$loop$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$EventLoopGameWindow$loop$lambda.prototype.constructor = Coroutine$EventLoopGameWindow$loop$lambda;
  Coroutine$EventLoopGameWindow$loop$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.exceptionState_0 = 2;
            this.state_0 = 1;
            this.result_0 = this.local$closure$entry(this.local$this$EventLoopGameWindow, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
          ...
          case 2:
            ...
            if (Kotlin.isType(e, Throwable)) {
              ...
              println(e);
              return this.local$this$EventLoopGameWindow.running = false, Unit;
            } else {
              throw e;
            }
  ...
  function EventLoopGameWindow$loop$lambda(closure$entry_0, this$EventLoopGameWindow_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$EventLoopGameWindow$loop$lambda(closure$entry_0, this$EventLoopGameWindow_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$loop_179clj$_0($this, entry_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$entry = entry_0;
  }
  Coroutine$loop_179clj$_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$loop_179clj$_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$loop_179clj$_0.prototype.constructor = Coroutine$loop_179clj$_0;
  Coroutine$loop_179clj$_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
          ...
          case 1:
            throw this.exception_0;
          case 2:
            launchImmediately(this.result_0, EventLoopGameWindow$loop$lambda(this.local$entry, this.$this));
            this.$this.doInitialize();
            this.$this.dispatchInitEvent();
            while (this.$this.running) {
              this.$this.doHandleEvents();
              if (this.$this.mustPerformRender()) {
                this.$this.coroutineDispatcher.currentTime = klock.PerformanceCounter.hr;
                this.$this.render_6taknv$(true);
              }if (!this.$this.vsync) {
                this.$this.sleepNextFrame();
              }}

            this.$this.dispatchStopEvent();
            this.$this.dispatchDestroyEvent();
            this.$this.doDestroy();
            return;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  EventLoopGameWindow.prototype.loop_179clj$ = function (entry_0, continuation_0, suspended) {
    var instance = new Coroutine$loop_179clj$_0(this, entry_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  EventLoopGameWindow.prototype.mustPerformRender = function () {
    return this.vsync ? true : this.elapsedSinceLastRenderTime().compareTo_11rb$(this.counterTimePerFrame) >= 0;
  };
  EventLoopGameWindow.prototype.elapsedSinceLastRenderTime = function () {
    return klock.PerformanceCounter.hr.minus_seyb0p$(this.lastRenderTime);
  };
  EventLoopGameWindow.prototype.render_6taknv$ = function (doUpdate) {
    this.lastRenderTime = klock.PerformanceCounter.hr;
    this.doInitRender();
    this.frame_kw6xyg$(doUpdate, this.lastRenderTime);
    this.doSwapBuffers();
  };
  EventLoopGameWindow.prototype.sleepNextFrame = function () {
    var now = klock.PerformanceCounter.hr;
    var frameTime = get_hrSeconds_0(1 / this.fps);
    var delay = frameTime.minus_seyb0p$(now.rem_seyb0p$(frameTime));
    if (delay.compareTo_11rb$(get_hrNanoseconds_0(0)) > 0) {
      blockingSleep(delay);
    }};
  EventLoopGameWindow.prototype.sleep_seyb0p$ = function (time) {
    var start = klock.PerformanceCounter.hr;
    while (klock.PerformanceCounter.hr.minus_seyb0p$(start).compareTo_11rb$(time) < 0) {
      this.doSmallSleep();
    }
  };
  EventLoopGameWindow.prototype.doSmallSleep = function () {
    if (!this.vsync) {
      blockingSleep(get_hrMilliseconds(0.1));
    }};
  EventLoopGameWindow.prototype.doHandleEvents = function () {
  };
  EventLoopGameWindow.prototype.doInitRender = function () {
  };
  EventLoopGameWindow.prototype.doSwapBuffers = function () {
  };
  EventLoopGameWindow.prototype.doInitialize = function () {
  };
  EventLoopGameWindow.prototype.doDestroy = function () {
  };
  EventLoopGameWindow.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'EventLoopGameWindow',
    interfaces: [GameWindow]
  };
  function ZenityDialogs() {
  }
  ZenityDialogs.prototype.exec_vqirvp$ = function (args, continuation) {
    return std.localCurrentDirVfs.execToString_rejnxc$(toList_0(args), void 0, void 0, void 0, void 0, continuation);
  };
  function Coroutine$browse_ptvjoy$($this, url_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$url = url_0;
  }
  Coroutine$browse_ptvjoy$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$browse_ptvjoy$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$browse_ptvjoy$.prototype.constructor = Coroutine$browse_ptvjoy$;
  Coroutine$browse_ptvjoy$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.exec_vqirvp$(['xdg-open', this.local$url.toString()], this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  ZenityDialogs.prototype.browse_ptvjoy$ = function (url_0, continuation_0, suspended) {
    var instance = new Coroutine$browse_ptvjoy$(this, url_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.exec_vqirvp$(['zenity', '--warning', '--text=' + this.local$message], this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  ZenityDialogs.prototype.alert_61zpoe$ = function (message_0, continuation_0, suspended) {
  ...
  function Coroutine$confirm_61zpoe$($this, message_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 5;
    this.$this = $this;
    this.local$message = message_0;
  }
  Coroutine$confirm_61zpoe$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$confirm_61zpoe$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$confirm_61zpoe$.prototype.constructor = Coroutine$confirm_61zpoe$;
  Coroutine$confirm_61zpoe$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.exceptionState_0 = 2;
            this.state_0 = 1;
            this.result_0 = this.$this.exec_vqirvp$(['zenity', '--question', '--text=' + this.local$message], this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  ZenityDialogs.prototype.confirm_61zpoe$ = function (message_0, continuation_0, suspended) {
    var instance = new Coroutine$confirm_61zpoe$(this, message_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$prompt_puj7f4$$default($this, message_0, default_1, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 5;
    this.$this = $this;
    this.local$message = message_0;
  ...
  Coroutine$prompt_puj7f4$$default.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$prompt_puj7f4$$default.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$prompt_puj7f4$$default.prototype.constructor = Coroutine$prompt_puj7f4$$default;
  Coroutine$prompt_puj7f4$$default.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.exceptionState_0 = 2;
            this.state_0 = 1;
            this.result_0 = this.$this.exec_vqirvp$(['zenity', '--question', '--text=' + this.local$message, '--entry-text=' + this.local$default], this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  ZenityDialogs.prototype.prompt_puj7f4$$default = function (message_0, default_1, continuation_0, suspended) {
    var instance = new Coroutine$prompt_puj7f4$$default(this, message_0, default_1, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$openFileDialog_r0su5d$$default($this, filter_0, write_0, multi_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$write = write_0;
    this.local$multi = multi_0;
  }
  Coroutine$openFileDialog_r0su5d$$default.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$openFileDialog_r0su5d$$default.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$openFileDialog_r0su5d$$default.prototype.constructor = Coroutine$openFileDialog_r0su5d$$default;
  Coroutine$openFileDialog_r0su5d$$default.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var $receiver = ArrayList_init();
            $receiver.add_11rb$('zenity');
            $receiver.add_11rb$('--file-selection');
            if (this.local$multi)
              $receiver.add_11rb$('--multiple');
            if (this.local$write)
              $receiver.add_11rb$('--save');
            this.state_0 = 2;
            this.result_0 = this.$this.exec_vqirvp$(copyToArray($receiver).slice(), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            throw this.exception_0;
          case 2:
            var $receiver_0 = split(this.result_0, ['\n']);
            ...
            while (tmp$_2.hasNext()) {
              var item_0 = tmp$_2.next();
              var tmp$_3;
              destination_1.add_11rb$(localVfs(trim(Kotlin.isCharSequence(tmp$_3 = item_0) ? tmp$_3 : throwCCE()).toString()));
            }
  ...
  ZenityDialogs.prototype.openFileDialog_r0su5d$$default = function (filter_0, write_0, multi_0, continuation_0, suspended) {
    var instance = new Coroutine$openFileDialog_r0su5d$$default(this, filter_0, write_0, multi_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  ZenityDialogs.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ZenityDialogs',
    interfaces: [DialogInterface]
  };
  ...
  function delay$lambda(closure$dispatcher, closure$time) {
    return function (cont) {
      closure$dispatcher.scheduleResumeAfterDelay_mza3h6$(closure$time, cont);
      return Unit;
    };
  }
  function Coroutine$delay(time_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            if (this.local$time.microsecondsDouble <= 0.0) {
              return;
            } else {
              this.state_0 = 2;
              continue;
          ...
          case 1:
            throw this.exception_0;
          case 2:
            var dispatcher = Kotlin.isType(tmp$ = this.context.get_j3r2sn$(ContinuationInterceptor.Key), GameWindowCoroutineDispatcher) ? tmp$ : null;
            if (dispatcher != null) {
              this.state_0 = 4;
              this.result_0 = suspendCancellableCoroutine$lambda(delay$lambda(dispatcher, this.local$time))(this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            } else {
              this.state_0 = 3;
              this.result_0 = delay(Kotlin.Long.fromNumber(this.local$time.millisecondsDouble), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
  ...
  function delay_0(time_0, continuation_0, suspended) {
    var instance = new Coroutine$delay(time_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  BrowserGameWindow.prototype.onResized_0 = function () {
    this.isTouchDeviceCache_0 = null;
    var scale = this.quality.computeTargetScale_bgskq8$(window.innerWidth, window.innerHeight, this.ag.devicePixelRatio);
    this.canvasRatio = scale;
    this.canvas.width = numberToInt(window.innerWidth * scale);
    this.canvas.height = numberToInt(window.innerHeight * scale);
  ...
  BrowserGameWindow.prototype.transformEventX_14dthe$ = defineInlineFunction('korgw-root-korgw.com.soywiz.korgw.BrowserGameWindow.transformEventX_14dthe$', function (x) {
    return x * this.canvasRatio;
  });
  BrowserGameWindow.prototype.transformEventY_14dthe$ = defineInlineFunction('korgw-root-korgw.com.soywiz.korgw.BrowserGameWindow.transformEventY_14dthe$', function (y) {
    return y * this.canvasRatio;
  });
  BrowserGameWindow.prototype.keyEvent_0 = function (me) {
    ...
    switch (me.key) {
      ...
      case 'F25':
        ...
        break;
      case '+':
        tmp$_0 = Key$PLUS_getInstance();
        break;
      case '-':
        tmp$_0 = Key$MINUS_getInstance();
        break;
  ...
  BrowserGameWindow.prototype.touchEvent_0 = function (e, type) {
    ...
    for (var n = 0; n < tmp$; n++) {
      tmp$_0 = e.touches.item(n);
      if (tmp$_0 == null) {
        continue;
      }var touch = tmp$_0;
      this.touchEvent.touch_w4xg1m$(touch.identifier, touch.clientX * this.canvasRatio, touch.clientY * this.canvasRatio);
    }
    var event = this.touchEvent;
    this.dispatch_nipq8w$(getKClass(TouchEvent), event);
  };
  BrowserGameWindow.prototype.mouseEvent_0 = function (e, type, pressingType) {
    ...
    if (!this.is_touch_device()) {
      var tx = numberToInt(e.clientX * this.canvasRatio);
      var ty = numberToInt(e.clientY * this.canvasRatio);
      var $receiver = this.mouseEvent;
  ...
  Object.defineProperty(BrowserGameWindow.prototype, 'bufferWidth', {
    get: function () {
      return this.canvas.width;
    }
  });
  Object.defineProperty(BrowserGameWindow.prototype, 'bufferHeight', {
    get: function () {
  ...
  function Coroutine$loop_179clj$_1($this, entry_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$entry = entry_0;
  }
  Coroutine$loop_179clj$_1.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$loop_179clj$_1.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$loop_179clj$_1.prototype.constructor = Coroutine$loop_179clj$_1;
  Coroutine$loop_179clj$_1.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
          ...
          case 1:
            throw this.exception_0;
          case 2:
            this.$this.loopJob_0 = launchImmediately(this.result_0, BrowserGameWindow$loop$lambda(this.local$entry, this.$this));
            this.$this.jsFrame_0(0.0);
            return;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
  ...
  BrowserGameWindow.prototype.loop_179clj$ = function (entry_0, continuation_0, suspended) {
    var instance = new Coroutine$loop_179clj$_1(this, entry_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  function BrowserGameWindow_init$lambda_16(this$BrowserGameWindow) {
    return function (step) {
      var startTime = klock.PerformanceCounter.hr;
      ...
      try {
        ...
        var elapsed = klock.PerformanceCounter.hr.minus_seyb0p$(startTime);
        var available = this$BrowserGameWindow.counterTimePerFrame.minus_seyb0p$(elapsed);
        this$BrowserGameWindow.coroutineDispatcher.executePending_seyb0p$(available);
      }
      return Unit;
    };
  }
  ...
  AGOpengl.ShaderException = AGOpengl$ShaderException;
  ...
  package$gl.toNewGlslString_s7696j$ = toNewGlslString;
  package$gl.toNewGlslStringResult_s7696j$ = toNewGlslStringResult;
  package$gl.toGlSlString_r8gd35$ = toGlSlString;
  package$gl.toGlSlString_7ggs2z$ = toGlSlString_0;
  Object.defineProperty(GlslGenerator, 'Companion', {
    get: GlslGenerator$Companion_getInstance
  });
  GlslGenerator.Result = GlslGenerator$Result;
  ...
  Object.defineProperty(MouseButton, 'BUTTON6', {
    get: MouseButton$BUTTON6_getInstance
  });
  Object.defineProperty(MouseButton, 'BUTTON7', {
    get: MouseButton$BUTTON7_getInstance
  });
  ...
  package$korgw.GameWindowCoroutineDispatcherSetNow = GameWindowCoroutineDispatcherSetNow;
  ...
  package$korgw.EventLoopGameWindow = EventLoopGameWindow;
  package$korgw.ZenityDialogs = ZenityDialogs;
  ...
  package$korgw.delay_seyb0p$ = delay_0;
  ...
  GameWindow.prototype.browse_ptvjoy$ = DialogInterface.prototype.browse_ptvjoy$;
  GameWindow.prototype.alert_61zpoe$ = DialogInterface.prototype.alert_61zpoe$;
  GameWindow.prototype.confirm_61zpoe$ = DialogInterface.prototype.confirm_61zpoe$;
  GameWindow.prototype.prompt_puj7f4$$default = DialogInterface.prototype.prompt_puj7f4$$default;
  GameWindow.prototype.openFileDialog_r0su5d$$default = DialogInterface.prototype.openFileDialog_r0su5d$$default;
  ...
  ZenityDialogs.prototype.prompt_puj7f4$ = DialogInterface.prototype.prompt_puj7f4$;
  ZenityDialogs.prototype.openFileDialog_r0su5d$ = DialogInterface.prototype.openFileDialog_r0su5d$;
